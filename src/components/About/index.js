...
import profile from '../../assets/images/LRC.png';
					...
					<div className="row">
						...
						<div
							...
							<p style={{ margin: '20px 10px 0 10px', textAlign: 'justify', fontSize: '1.1em', color:'	#282828' }}>
								...
								development from the University of Central Florida bootcamp. Graduated with
								Bachelor of System Engineering from Santiago Marino University, Venezuela.
								Worked as ‘Warehouse Manager’ in Mastec Advance Technologie for about 20 year.
							</p>
							<p
