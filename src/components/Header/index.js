...
import resume from '../../assets/resume-lrc.pdf';

export default function Header() {
  return (
    <>
      <div className= "text-center header-section justify-content-center text-white">
        <h1 className="header-name">I'm Luis Cartaya</h1>
        <p className="header-description">Full Stack Web Developer in Kissimmee, Florida.</p>
        <div className ='container mb-3 mt-4' >
            <a href="https://github.com/cartaya1" className="btn tooltip-test icon" title="Github" target="_blank" rel="noopener noreferrer"
                style={{fontSize:25, color:'#E8E8E8', marginRight:10}}><i className="fab fa-github"></i></a>
            <a href="https://www.linkedin.com/in/cartaya1/" className="btn tooltip-test icon" title="Linkedin"
                target="_blank" rel="noopener noreferrer" style={{fontSize:25,color:'#E8E8E8',marginRight:10}}><i className="fab fa-linkedin"></i></a>
            <a href="mailto: cartaya1@msn.com" className="btn tooltip-test icon" title="Email" target="_blank" rel="noopener noreferrer"
